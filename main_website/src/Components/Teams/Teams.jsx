        ...
        <div className="row">
            ...
            <div className="col-lg-8 col-md-12 col-sm-12 col-12">
                <div className="content aos-init aos-animate" data-aos="fade-up">
                    ...
                    <a className="read_more" href="./about.html">Read More<i className="circle fa-regular fa-angle-right"></i></a>
                </div>
            </div>
        </div>
        <div className="choose_wrapper position-relative">                   
            <figure className="choose-image mb-0">
                <img src="./assets/images/choose-image.png" className="img-fluid" alt=""/>
            </figure>
        </div>   
    </div>
</section>
